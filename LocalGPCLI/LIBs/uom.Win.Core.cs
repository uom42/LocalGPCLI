...
namespace uom
{
	...
	internal static partial class OS
	{
		...
		internal static OSVERSIONINFOEX CurrentOS => OSVERSIONINFOEX.GetVersion();
		...
		internal struct OSVERSIONINFOEX
		{
			...
			public readonly Version SPVersion
				=> new(wServicePackMajor, wServicePackMinor);
			...
			{
				var spVersion = SPVersionString;
				if (spVersion.IsNotNullOrWhiteSpace())
...
[MarshalAs(UnmanagedType.LPTStr)] string lpNewKeyName);
			...
			public static extern Win32Error RegRenameKey (HKEY hKey, string lpSubKeyName, string lpNewKeyName);
