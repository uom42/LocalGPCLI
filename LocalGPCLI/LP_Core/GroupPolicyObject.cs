...
namespace LocalPolicy
{
    public abstract class GroupPolicyObject
    {
        ...
        internal GroupPolicyObject() => instance = getInstance();
        ...
        public string UniqueName { get => getString(instance.GetName, "Unable to retrieve name"); }
        ...
        public string Path { get => getString(instance.GetPath, "Unable to retrieve path"); }
        ...
        public GroupPolicyObjectOptions Options
        {
            ...
            set => trycatch(() => instance.SetOptions(value.Flag, value.Mask), "Unable to set options");
        }
        ...
        protected static T withSingleThreadedApartmentCheck<T>(Func<T> operation)
        {
            ...
            {
                if (System.Threading.Thread.CurrentThread.GetApartmentState() != System.Threading.ApartmentState.STA) throw new RequiresSingleThreadedApartmentException(e);
                else throw e;
            }
        }
